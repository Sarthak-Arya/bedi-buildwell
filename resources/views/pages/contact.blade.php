...
<head>
    ...
    <title>Contact &#8211; Bedi Buildwell</title>
    ...
    <link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed"
        href="https://live.21lab.co/hank/wp-json/oembed/1.0/embed?url=https%3A%2F%2Flive.21lab.co%2Fhank%2Fcontact%2F" />
    <link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed"
        href="https://live.21lab.co/hank/wp-json/oembed/1.0/embed?url=https%3A%2F%2Flive.21lab.co%2Fhank%2Fcontact%2F&#038;format=xml" />
    ...
    <link rel="alternate" title="JSON" type="application/json"
        href="https://live.21lab.co/hank/wp-json/wp/v2/pages/144" />
    ...
    <link rel='shortlink' href='https://live.21lab.co/hank/?p=144' />
    <noscript>
        <style>
    ...
    <style type="text/css" data-type="vc_shortcodes-custom-css">
        ...
        .vc_custom_1582422117613 {
            padding-top: 70px !important;
        }

        .vc_custom_1582779812584 {
        ...
        .vc_custom_1644801471038 {
            background: #f2f2f2 url(https://live.21lab.co/hank/wp-content/uploads/2019/11/slider-3-scaled.jpg?id=223) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }

        .vc_custom_1582337290734 {
            background-position: 0 0 !important;
            background-repeat: no-repeat !important;
        }

        .vc_custom_1644801517561 {
            background-image: url(https://live.21lab.co/hank/wp-content/uploads/2022/02/mapbg.jpg?id=1153) !important;
            background-position: center !important;
            background-repeat: no-repeat !important;
            background-size: cover !important;
        }

        .vc_custom_1582779840306 {
            padding-top: 80px !important;
        }

        .vc_custom_1582796337328 {
            padding-bottom: 60px !important;
        }

        .vc_custom_1582796345110 {
            padding-bottom: 60px !important;
        }

        .vc_custom_1582796354572 {
            padding-bottom: 60px !important;
        }
    </style><noscript>
        <style>
...
<body
    class="wp-singular page-template page-template-tmpl page-template-template-fullwidth page-template-tmpltemplate-fullwidth-php page page-id-144 wp-theme-hank theme-hank woocommerce-no-js sliding-desktop-off sliding-overlay layout-wide wpb-js-composer js-comp-ver-6.8.0 vc_responsive"
                                                ...
                                                <div class="vc_column-inner">
                                                    <div class="wpb_wrapper">
                                                        <div style="font-size: 40px;color: #ffffff;line-height: 44px;text-align: left"
                                                            class="vc_custom_heading">tell us about your project<br />
                                                            we're excited to <strong>work together.</strong></div>
                                        ...
                                        <div class="row-inner">
                                            <div
                                                ...
                                                <div class="vc_column-inner vc_custom_1574391351816">
                                                    <div class="wpb_wrapper">
                                                        <div role="form" class="wpcf7" id="wpcf7-f5-p144-o1"
                                                            lang="en-US" dir="ltr">
                                                            ...
                                                            <form action="/hank/contact/#wpcf7-f5-p144-o1"
                                                                ...
                                                                <div class="field line">
                                                                    <label>I'm a/an</label><br />
                                                                    <span
                                                                        class="wpcf7-form-control-wrap menu-571"><select
                                                                            name="menu-571"
                                                                    ...
                                                                    <span
                                                                        class="wpcf7-form-control-wrap menu-393"><select
                                                                            ...
                                                                            <option
                                                                                ...
                                                                                Call me to Discuss my Questions</option>
                                                                            <option
                                                                ...
                                                                <div class="field line">
                                                                    ...
                                                                    <span
                                                                        class="wpcf7-form-control-wrap menu-554"><select
                                                                            ...
                                                                            class="wpcf7-form-control wpcf7-select"
                                                                            aria-invalid="false">
                                                                            <option value="Design Build">Design Build
                                                                            </option>
                                                                            <option value="Construction Management">
                                                                                Construction Management</option>
                                                                            <option value="New Build">New Build
                                                                            </option>
                                                                            <option value="Preconstruction Services">
                                                                                Preconstruction Services</option>
                                                                            <option value="General Contracting">General
                                                                                Contracting</option>
                                                                ...
                                                                <div class="field">
                                                                    ...
                                                                    <span
                                                                        class="wpcf7-form-control-wrap text-794"><input
                                                                            type="text" name="text-794"
                                                                            value="" size="40"
                                                                            class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required"
                                                                            aria-required="true" aria-invalid="false"
                                                                            placeholder="Eg: John Doe" /></span>
                                                                </div>
                                                                ...
                                                                <div class="field">
                                                                    ...
                                                                    <span class="wpcf7-form-control-wrap textarea-43">
                                                                        <textarea name="textarea-43" cols="40" rows="10"
                                                                            ...
                                                                            class="wpcf7-form-control-wrap acceptance-838"><span
                                                                                class="wpcf7-form-control wpcf7-acceptance"><span
                                                                                    class="wpcf7-list-item"><label><input
                                                                                            ...
                                                                                            agree to receive
                                                                                            communications from Hank
                                                                                            Construction.</span></label></span></span></span>
                                                                    </div>
                                                                    <div class="field">
                                            ...
                                            <div
                                                class="wpb_column vc_column_container vc_col-sm-6 vc_hidden-md vc_hidden-sm vc_hidden-xs vc_col-has-fill">
                                                <div class="vc_column-inner vc_custom_1644801471038">
                                                    <div class="wpb_wrapper"></div>
                                                </div>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="wpb_wrapper">
                                                                <p style="text-align: center;"><span
                                                                        style="color: #b7b7b7;"><strong>Join our
                                                                            team</strong> – We are looking for talented
                                                                        &amp; driven people to come work with us. <a
...
<!-- This website is like a Rocket, isn't it? Performance optimized by WP Rocket. Learn more: https://wp-rocket.me - Debug: cached@1765245834 -->
